        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          <div className="flex flex-col items-center mb-8">
            <Link to="/" className="flex items-center gap-2">
              ...
              <h1 className="text-2xl">OmniPost</h1>
            </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 text-sm">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-linear-to-r from-purple-600 to-indigo-600 hover:opacity-95 text-white rounded-full text-sm transition-all disabled:opacity-60 flex items-center justify-center gap-2"
            >
              {loading ? (
                "Signing in..."
              ) : (
