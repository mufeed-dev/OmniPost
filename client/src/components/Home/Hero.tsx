  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center">
        <div className="inline-flex items-center gap-2 bg-purple-50/80 border border-purple-100/80 text-purple-600 dark:bg-purple-950/20 dark:border-purple-900/30 dark:text-purple-400 text-sm px-3.5 py-1.5 rounded-full mb-8">
        ...
        <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-slate-900">
          Schedule smarter.
          <br />
          <span className="bg-linear-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent font-semibold italic">Grow faster.</span>
        </h1>
        <p className="mt-7 text-slate-500 dark:text-slate-400 text-base sm:text-lg md:text-xl font-normal leading-relaxed max-w-2xl mx-auto tracking-wide">
          OmniPost lets you create, schedule, and auto-engage across all your
        ...
        <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            to="/login"
            className="bg-linear-to-r from-purple-600 to-indigo-600 text-white rounded-full font-medium hover:opacity-95 hover:shadow-[0_8px_24px_rgba(124,58,237,0.35)] inline-flex items-center gap-2 text-[15px] px-8 py-3.5 w-full sm:w-auto justify-center transition-all"
          >
